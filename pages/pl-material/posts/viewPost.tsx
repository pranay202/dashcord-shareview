                    ...
                    <div className="flex flex-col gap-1">
                        <div className="flex justify-between">
                            ...
                            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer">
                                <button className="bg-[#0077B7] text-white font-bold px-1.5 py-0.5 tracking-wider rounded">in</button>
                            </a>
                        </div>
                        <hr className="border-gray-400" />
                            ...
                            <form
                                ...
                                method="POST"
                                >
                                <button onClick={onClick} className={`px-2 py-1 mt-2 border border-green-700 rounded hover:text-green-500 hover:bg-white ${ follow ? 'text-green-500 font-semibold bg-white': 'text-white bg-green-500'}`}>
